    ...
    <div class="container text-light">
        <div class="w-100 d-flex justify-content-end">
            <div>
                ...
                <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:info@company.com">DynamicHouse@gmail.com</a>
                <i class="fa fa-phone mx-2"></i>
                <a class="navbar-sm-brand text-light text-decoration-none" href="tel:010-020-0340">0368281593</a>
            </div>
            <div>
...
<%--                    <a href="#" class="nav-link dropdown-toggle bg-primary text-white pe-5 ms-lg-5 justify-content-center" data-bs-toggle="dropdown">${sessionScope.user.userName}</a>--%>
                    ...
                    <div class="dropdown-menu m-0 dropdown-menu-end px-2">
                        <a class="nav-link position-relative pb-0 text-decoration-none d-flex justify-content-start align-items-start border-bottom mt-2" href="update-profile">
                            <img src="${sessionScope.user.avatarImg}" alt=""
                        ...
                        <a href="logout" class="my-2 dropdown-item text-white text-center bg-danger">Đăng Xuất</a>
                    </div>
                </div>
            </c:if>
        </div>
