...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    ...
    <div class="row border rounded-5 p-3 bg-white shadow box-area">
        ...
        <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
             style="
                    background-image: url(./assets/img/dynamichouse.png);
            ...
            <div class="row align-items-center">
                ...
                <form action="login" method="post">
                    <div class="input-group  mb-3">
                        ...
                        <input maxlength="100" type="text" name="userOrEmail"
                               class="form-control form-control-lg bg-light fs-6 p-1"
                               placeholder=" Địa chỉ email hoặc Người dùng">
                    </div>
                    <div class="input-group mb-1">
                        <div class="input-group-prepend ">
                            <div class="input-group-text p-3"><i class="fa-solid fa-key fa-bounce"
                                                                 style="color: #050505;"></i></div>
                        </div>
                        <input maxlength="50" type="password" name="passWord" id="myInput"
                               class="form-control form-control-lg bg-light fs-6  p-1" placeholder=" Mật Khẩu">
                    ...
                    <%
                        ...
                        if (userOrEmail != null) {
                    %>
                    <div class="alert alert-danger" style="color: red"><%= userOrEmail%>
                    </div>
                    <%
                    ...
                    <c:if test="${error == 1}">
                        <div class="alert alert-danger" style="color: red">Tài khoản này đang tạm khóa vui lòng liên hệ
                            admin
                        </div>
                    </c:if>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <button class="btn btn-lg btn-primary w-100 fs-6"><i
                                class="fa-solid fa-right-to-bracket fa-beat-fade" style="color: #000000;"></i> Đăng nhập
                        </button>
